...
namespace Drivious.Controllers
{
    ...
    public class DriversController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] DriverQueryParameters parameters)
        {
        ...
        [Authorize(Roles = AppRoles.ManageFleet)]
        [HttpGet("deleted")]
        public async Task<IActionResult> GetDeleted([FromQuery] DriverQueryParameters parameters)
        {
