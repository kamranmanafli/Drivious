...
namespace Drivious.Controllers
{
    ...
    public class IncomesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] IncomeQueryParameters parameters)
        {
        ...
        [Authorize(Roles = AppRoles.ManageFleet)]
        [HttpGet("deleted")]
        public async Task<IActionResult> GetDeleted([FromQuery] IncomeQueryParameters parameters)
        {
