...
namespace Drivious.Controllers
{
    ...
    public class MaintenancesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] MaintenanceQueryParameters parameters)
        {
        ...
        [Authorize(Roles = AppRoles.ManageFleet)]
        [HttpGet("deleted")]
        public async Task<IActionResult> GetDeleted([FromQuery] MaintenanceQueryParameters parameters)
        {
